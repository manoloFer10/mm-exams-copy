...
system_message = {
    "en": "You are an expert at solving multiple-choice questions. Carefully analyze the question, think step by step, and provide your FINAL answer between the tags <ANSWER> X </ANSWER>, where X is ONLY the correct letter of your choice. Do not write any additional text between the tags.",
    "es": "Eres un experto en resolver preguntas de opción múltiple. Analiza cuidadosamente la pregunta, piensa paso a paso y proporciona tu RESPUESTA FINAL entre las etiquetas <ANSWER> X </ANSWER>, donde X es ÚNICAMENTE la letra correcta de tu elección. No escribas texto adicional entre las etiquetas.",
    "hi": "आप बहुविकल्पीय प्रश्नों को हल करने में विशेषज्ञ हैं। प्रश्न का सावधानीपूर्वक विश्लेषण करें, चरणबद्ध सोचें, और फिर <ANSWER> X </ANSWER> टैग के बीच अपना अंतिम उत्तर प्रदान करें, जहाँ X केवल आपके चयन का सही अक्षर है। टैग के बीच अतिरिक्त कोई पाठ न लिखें।",
    "hu": "Te egy szakértő vagy a feleletválasztós kérdések megoldásában. Gondosan elemezd a kérdést, gondolkodj lépésről lépésre, és add meg a VÉGSŐ válaszodat a <ANSWER> X </ANSWER> címkék között, ahol X CSAK a választott helyes betű. Ne írj további szöveget a címkék közé.",
    "hr": "Vi ste stručnjak za rješavanje pitanja s višestrukim izborom. Pažljivo analizirajte pitanje, razmišljajte korak po korak i dajte svoj ZAVRŠNI odgovor između oznaka <ANSWER> X </ANSWER>, gdje je X SAMO ispravno slovo vašeg izbora. Nemojte pisati dodatni tekst između oznaka.",
    "uk": "Ви є експертом у розв’язанні питань з множинним вибором. Уважно проаналізуйте питання, думайте крок за кроком і надайте вашу ОСТАННЮ відповідь між тегами <ANSWER> X </ANSWER>, де X — ЛИШЕ правильна літера за вашим вибором. Не пишіть додаткового тексту між тегами.",
    "pt": "Você é um especialista em resolver questões de múltipla escolha. Analise cuidadosamente a questão, pense passo a passo e forneça sua RESPOSTA FINAL entre as tags <ANSWER> X </ANSWER>, onde X é SOMENTE a letra correta da sua escolha. Não escreva texto adicional entre as tags.",
    "bn": "আপনি বহু-বিকল্প প্রশ্ন সমাধানে বিশেষজ্ঞ। প্রশ্নটি সতর্কতার সাথে বিশ্লেষণ করুন, ধাপে ধাপে চিন্তা করুন এবং তারপর <ANSWER> X </ANSWER> ট্যাগের মধ্যে আপনার চূড়ান্ত উত্তর প্রদান করুন, যেখানে X শুধুমাত্র আপনার পছন্দের সঠিক অক্ষর। ট্যাগগুলির মধ্যে অতিরিক্ত কোনো লেখা লিখবেন না।",
    "te": "మీరు బహుళ ఎంపిక ప్రశ్నలను పరిష్కరించడంలో నిపుణులు. ప్రశ్నను జాగ్రత్తగా విశ్లేషించి, దశల వారీగా ఆలోచించి, <ANSWER> X </ANSWER> ట్యాగ్లలో మీ తుది సమాధానాన్ని ఇవ్వండి, ఇక్కడ X మీ ఎంపికలోని సరైన అక్షరం మాత్రమే. ట్యాగ్లలో అదనపు వచనం రాయవద్దు.",
    "ne": "तपाईं बहुविकल्पीय प्रश्नहरू समाधान गर्न विशेषज्ञ हुनुहुन्छ। प्रश्नलाई ध्यानपूर्वक विश्लेषण गर्नुहोस्, चरणबद्ध रूपमा सोच्नुहोस्, र आफ्नो अन्तिम उत्तर <ANSWER> X </ANSWER> ट्यागहरू बीच प्रदान गर्नुहोस्, जहाँ X केवल तपाईंको सही छनौट भएको अक्षर हो। ट्यागहरू बीच अतिरिक्त कुनै पाठ नलेख्नुहोस्।",
    "sr": "Vi ste stručnjak za rešavanje pitanja sa višestrukim izborom. Pažljivo analizirajte pitanje, razmišljajte korak po korak i navedite svoj KONAČNI odgovor između oznaka <ANSWER> X </ANSWER>, gde je X ISKLJUČIVO tačno slovo vašeg izbora. Ne pišite dodatni tekst između oznaka.",
    "nl": "Je bent een expert in het oplossen van meerkeuzevragen. Analyseer de vraag zorgvuldig, denk stap voor stap en geef je DEFINITIEVE antwoord tussen de tags <ANSWER> X </ANSWER>, waarbij X ALLEEN de juiste letter van je keuze is. Schrijf geen extra tekst tussen de tags.",
    "ar": "أنت خبير في حل أسئلة الاختيار من متعدد. قم بتحليل السؤال بعناية، فكر خطوة بخطوة، وقدم إجابتك النهائية بين الوسوم <ANSWER> X </ANSWER>، حيث X هو الحرف الصحيح فقط لاختيارك. لا تكتب أي نص إضافي بين الوسوم.",
    "ru": "Вы эксперт в решении вопросов с множественным выбором. Внимательно проанализируйте вопрос, подумайте шаг за шагом и предоставьте свой ОКОНЧАТЕЛЬНЫЙ ответ между тегами <ANSWER> X </ANSWER>, где X — ТОЛЬКО правильная буква вашего выбора. Не пишите дополнительный текст между тегами.",
    "fr": "Vous êtes un expert dans la résolution de questions à choix multiples. Analysez soigneusement la question, réfléchissez étape par étape et fournissez votre RÉPONSE FINALE entre les balises <ANSWER> X </ANSWER>, où X est UNIQUEMENT la lettre correcte de votre choix. Ne rédigez aucun texte supplémentaire entre les balises.",
    "fa": "شما در حل سؤالات چندگزینه‌ای متخصص هستید. پرسش را با دقت تحلیل کنید، گام‌به‌گام فکر کنید و پاسخ نهایی خود را بین برچسب‌های <ANSWER> X </ANSWER> ارائه دهید، جایی که X فقط حرف صحیح انتخابی شماست. هیچ متن اضافی بین برچسب‌ها ننویسید.",
    "de": "Sie sind ein Experte für das Lösen von Multiple-Choice-Fragen. Analysieren Sie die Frage sorgfältig, denken Sie Schritt für Schritt und geben Sie Ihre ENDGÜLTIGE Antwort zwischen den Tags <ANSWER> X </ANSWER> an, wobei X NUR der richtige Buchstabe Ihrer Wahl ist. Schreiben Sie keinen zusätzlichen Text zwischen die Tags.",
    "lt": "Jūs esate ekspertas sprendžiant daugiatikslės pasirinkimo klausimus. Atidžiai išanalizuokite klausimą, mąstykite žingsnis po žingsnio ir pateikite savo GALUTINĮ atsakymą tarp žymų <ANSWER> X </ANSWER>, kur X yra TIK teisinga jūsų pasirinkta raidė. Nerašykite jokio papildomo teksto tarp žymų.",
}

instruction = {
    "en": "Think step by step and provide your final answer between the tags <ANSWER> X </ANSWER> to solve the following question:",
    "es": "Piensa paso a paso y proporciona tu respuesta final entre las etiquetas <ANSWER> X </ANSWER> para resolver la siguiente pregunta:",
    "hi": "चरणबद्ध सोचें और निम्नलिखित प्रश्न को हल करने के लिए <ANSWER> X </ANSWER> टैग के बीच अपना अंतिम उत्तर प्रदान करें:",
    "hu": "Gondolkodj lépésről lépésre, és add meg a végső válaszodat a <ANSWER> X </ANSWER> címkék között a következő kérdés megoldásához:",
    "hr": "Razmišljajte korak po korak i navedite svoj konačni odgovor između oznaka <ANSWER> X </ANSWER> kako biste riješili sljedeće pitanje:",
    "uk": "Думайте крок за кроком і надайте вашу остаточну відповідь між тегами <ANSWER> X </ANSWER>, щоб розв’язати наступне питання:",
    "pt": "Pense passo a passo e forneça sua resposta final entre as tags <ANSWER> X </ANSWER> para resolver a seguinte questão:",
    "bn": "ধাপে ধাপে চিন্তা করুন এবং নিম্নলিখিত প্রশ্নের সমাধানের জন্য <ANSWER> X </ANSWER> ট্যাগের মধ্যে আপনার চূড়ান্ত উত্তর প্রদান করুন:",
    "te": "దశల వారీగా ఆలోచించి, క్రింది ప్రశ్నను పరిష్కరించేందుకు <ANSWER> X </ANSWER> ట్యాగ్లలో మీ తుది సమాధానాన్ని ఇవ్వండి:",
    "ne": "चरणबद्ध रूपमा सोच्नुहोस् र निम्न प्रश्न समाधान गर्न <ANSWER> X </ANSWER> ट्यागहरू बीच आफ्नो अन्तिम उत्तर प्रदान गर्नुहोस्:",
    "sr": "Razmišljajte korak po korak i navedite svoj konačni odgovor između oznaka <ANSWER> X </ANSWER> kako biste rešili sledeće pitanje:",
    "nl": "Denk stap voor stap en geef je definitieve antwoord tussen de tags <ANSWER> X </ANSWER> om de volgende vraag op te lossen:",
    "ar": "فكر خطوة بخطوة وقدم إجابتك النهائية بين الوسوم <ANSWER> X </ANSWER> لحل السؤال التالي:",
    "ru": "Думайте шаг за шагом и укажите свой окончательный ответ между тегами <ANSWER> X </ANSWER> для решения следующего вопроса:",
    "fr": "Réfléchissez étape par étape et fournissez votre réponse finale entre les balises <ANSWER> X </ANSWER> pour résoudre la question suivante :",
    "fa": "گام‌به‌گام فکر کنید و پاسخ نهایی خود را بین برچسب‌های <ANSWER> X </ANSWER> برای حل سوال زیر ارائه دهید:",
    "de": "Denken Sie Schritt für Schritt und geben Sie Ihre endgültige Antwort zwischen den Tags <ANSWER> X </ANSWER> an, um die folgende Frage zu lösen:",
    "lt": "Mąstykite žingsnis po žingsnio ir pateikite savo galutinį atsakymą tarp žymų <ANSWER> X </ANSWER>, kad išspręstumėte šį klausimą:",
}
